...
**2. Plná náhrada base** — vytvoř `~/.config/jailoc/Dockerfile`. Tohle nahradí celý base image. jailoc ho sestaví jako `jailoc-base:local` a použije místo pullování z registry. Sáhni po tomhle, pokud potřebuješ base úplně vyměnit.
