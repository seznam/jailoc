...
Core tool versions (Node.js, yaml-language-server, OpenCode) are pinned as `ARG` declarations at the top of the Dockerfile. Other npm-installed language servers use the latest version at build time.
