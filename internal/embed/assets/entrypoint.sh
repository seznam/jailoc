...
if [ "${JAILOC_FILTERED_DNS:-}" = 1 ]; then
  ...
  $IPT -I OUTPUT -p tcp -d 169.254.53.53 --dport 53 -j ACCEPT
  $IPT -I OUTPUT -p udp -d 169.254.53.53 --dport 53 -j ACCEPT
